...
class Execution(Base):
    ...
    pass_rate: Mapped[float] = mapped_column(Numeric(5, 2), nullable=False, default=0.00)
    executed_by: Mapped[int | None] = mapped_column(Integer, nullable=True, default=None)
    ...
    def __repr__(self):
        return (
            ...
            f"failed_cases={self.failed_cases} "
            f"pass_rate={self.pass_rate} "
            f"executed_by={self.executed_by}>"
        )
